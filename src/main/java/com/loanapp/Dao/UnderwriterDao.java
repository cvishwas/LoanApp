...
public class UnderwriterDao {
	...
	public List<LoanDataUnderwriter> getUnderWriterData()
	{
		...
		String queryString = "select a.loan_id,a.loan_type,a.customer_id,a.loan_status,a.review_status from loan_app_loans a, loan_app_loan_types b where "+"a.loan_id=b.LOAN_ID and a.review_status='reviewed'";
